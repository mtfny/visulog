...
public abstract class DateAnalyzerPlugin implements AnalyzerPlugin{

	/*
	 * Abstract class extended by plugins that may take starting and/or ending dates into account during the analysis, if at least one such date is specified by the user
	 */
